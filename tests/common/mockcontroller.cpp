...
void MockController::placeDeliveryReport(const QStringList &recipients, const QString &messageId, const QString &status)
{
    mMockInterface.call("PlaceDeliveryReport", recipients, messageId, status);
}
